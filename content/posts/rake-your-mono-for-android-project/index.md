...
Albacore is a suite of rake tasks for building .NET applications. With a trivial amount of effort, I managed to setup a command line build of my Xamarin.Android projects (which would also sign and zip align the APK file).
...
@signed_apk   = "ReportGraffiti.Androaid/bin/Release/net.opgenorth.reportgraffiti_signed_notaligned.apk"
